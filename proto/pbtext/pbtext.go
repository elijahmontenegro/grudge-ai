// Package pbtext holds generic threadv1.ContentBlock <-> plain-text helpers
// with no RRC semantics — the text view of proto content. It lives
// beside the generated types so consumers (resolvers, inserters,
// judges) don't import the engine for a string conversion.
package pbtext
...
func BlocksFromText(text string) []*threadv1.ContentBlock {
	return []*threadv1.ContentBlock{
