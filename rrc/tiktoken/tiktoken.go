...
// consumer's binary; importing rrc/chunk alone does not.
//
...
// chunk.TokenEstimator.
type estimator struct {
	enc *tiktoken.Tiktoken
}

// New loads the cl100k_base BPE encoder and returns it as a
// chunk.TokenEstimator. Returns an error if the encoder cannot be
...
func New() (chunk.TokenEstimator, error) {
