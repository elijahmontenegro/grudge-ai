...
func init() { core.RegisterCountProjection("googleai", CountText) }

// CountText is this adapter's counting projection: the text one wire
// message actually contributes to a Gemini REST request. Mirrors
// toGenerateRequest — text blocks only; thinking, tool-call,
