...
// Retryable reports whether the status code is plausibly transient.
// 408 (request timeout), 429 (rate limited), and any 5xx — those
// can resolve on a retry. Authentication / permission / not-found
// codes are permanent.
